...
# Railway terminates HTTPS at the edge and proxies HTTP to Django.
# This tells Django to trust the X-Forwarded-Proto header so it generates
# correct https:// URLs (fixes Mixed Content errors in the browser).
